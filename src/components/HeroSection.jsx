/**
 * HeroSection - The full-screen hero with background video,
 * NOTHIN' SVG wordmark, tagline overlay, and social links.
 * Preserves all data attributes and class names for GSAP animations.
 */
  ...
  return (
    <div className="section-w">
        ...
        <div className="link-hero-bottom-w">
          ...
          <div delay="1.5" opacity="" no-scroll="" className="link-hero-lang-w">
            <div className="link-hero-w">
              <a href="https://www.linkedin.com/company/nothin/" target="_blank" className="link hide-desk w-inline-block">
                <div>LKDN</div>
              </a>
              <a href="https://www.linkedin.com/company/nothin/" target="_blank" className="link hide-tablet w-inline-block">
                <div>Linkedin</div>
              </a>
              <a href="index.html#" className="link pointer-none w-inline-block">
                <div>/</div>
              </a>
              <a href="https://www.instagram.com/nooothinatall/" target="_blank" className="link hide-tablet w-inline-block">
                <div className="text-block-10">Instagram</div>
              </a>
              <a href="https://www.instagram.com/nooothinatall/" target="_blank" className="link hide-desk w-inline-block">
                <div>insta</div>
              </a>
            </div>
            <a href="index.html#" className="link-lang w-inline-block">
              <div>EN</div>
            </a>
          </div>
        </div>
      ...
      <video
        ...
        className="video-hero-bg video-hero-bg"
      ></video>
...
/**
 * The large NOTHIN' SVG wordmark used in the hero.
 * Extracted to keep the JSX readable.
 */
